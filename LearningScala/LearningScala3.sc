object LearningScala3 {
  ...
  def transformToUpperCase2(x: String, f: String => String) : String = {
  		f(x)
  }                                               //> transformToUpperCase2: (x: String, f: String => String)String
  transformToUpperCase("Eu cai da escada")        //> res3: String = EU CAI DA ESCADA
  
  transformToUpperCase2("Eu cai da escada", x => {x.toUpperCase()})
                                                  //> res4: String = EU CAI DA ESCADA
